...
// `Felt252` is used as the type of values stored in
...
mod tests {
    ...
    fn mem_indexes_are_contiguos_in_bytes_of_mul_program() {
        ...
        let bytes = hex::decode("").unwrap();
    ...
    fn test_wrong_amount_of_bytes_gives_err() {
        let bytes = hex::decode("").unwrap();
